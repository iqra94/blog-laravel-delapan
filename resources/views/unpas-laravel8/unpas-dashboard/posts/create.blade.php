...
@section('content')
  ...
  <div class="col-lg-8">
    <form action="/unpas-dashboard/posts" method="post" enctype="multipart/form-data">
      {{-- @csrf --}}
      <div class="mb-3">
      ...
      <button class="w-100 btn btn-primary btn-lg" type="submit">Create post</button>
    </form>
  </div>
